...
# known good build of this file into cv-dispense/realsense-arm image 
...
FROM gcr.io/fulfil-web-staging-296222/orin-cv:cuda12-ubuntu22 AS base
...
RUN apt-get install -qq -y --no-install-recommends \
    build-essential \
    libudev-dev libusb-dev build-essential \
    cmake \
    git \
    libssl-dev \
    libusb-1.0-0-dev \
    ...
    ca-certificates \
    libjson-c-dev \
    pkg-config libssl-dev libsasl2-dev openssl -y
...
RUN cd /home/fulfil/code/Fulfil.ComputerVision/Fulfil.DepthCam && make || (cat /home/fulfil/code/Fulfil.ComputerVision/Fulfil.DepthCam/CMakeFiles/CMakeOutput.log && exit 1)
