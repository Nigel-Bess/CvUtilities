...
int get_point_closest_to_mouth_of_bag(std::shared_ptr<LocalPointCloud> point_cloud, int square_coord_x, int square_coord_y, int square_width, int square_height) {
