...
namespace fulfil::dispense::commands {
    class SideDispenseTargetRequest final : public fulfil::dispense::commands::DispenseRequest
    {
    private:
    ...
    public:
         ...
         */
        explicit SideDispenseTargetRequest(std::shared_ptr<std::string> request_id, std::shared_ptr<std::string> PrimaryKeyID,
                                           std::shared_ptr<nlohmann::json> request_json);
