...
#ifndef FULFIL_DISPENSE_FLOOR_VIEW_REQUEST_H
#define FULFIL_DISPENSE_FLOOR_VIEW_REQUEST_H
...
{
    class FloorViewRequest : public fulfil::dispense::commands::DispenseRequest
    {
    public:
...
#endif //FULFIL_DISPENSE_FLOOR_VIEW_REQUEST_H
