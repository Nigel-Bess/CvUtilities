...
## 3. Replay perception against an arbitrary request ID
...
### 4. Replay perception against all requests and report output diffs.
...
## 5. Viewing Downloaded Dataset

# TODO: Replace this section with CVAT instructions
...
After running `Replay perception against all requests` above you can aggregate the results into a COCO format for easy bird's eye viewing by running:
