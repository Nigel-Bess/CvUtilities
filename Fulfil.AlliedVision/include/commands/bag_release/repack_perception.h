...
namespace fulfil::dispense::commands {
    ...
    class RepackPerception {
        ...
        */
        bool is_bot_ready_for_release(std::shared_ptr<cv::Mat> bag_image, std::string cameraId, std::string directory_path);

        void write_result_file(std::string labelFilename, std::string cameraId, int markerCount);
