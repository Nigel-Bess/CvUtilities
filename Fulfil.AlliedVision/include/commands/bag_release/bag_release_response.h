...
#ifndef FULFIL_DISPENSE_BAG_RELEASE_RESPONSE_H
#define FULFIL_DISPENSE_BAG_RELEASE_RESPONSE_H
...
namespace fulfil::dispense::commands {
  class BagReleaseResponse final
  {
  private:
...
#endif //FULFIL_DISPENSE_BAG_RELEASE_RESPONSE_H