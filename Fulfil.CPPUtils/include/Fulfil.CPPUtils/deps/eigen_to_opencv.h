//
// Created by amber on 9/10/20.
//

#ifndef FULFIL_DISPENSE_MATRIX3XD_CV_CONVERTER_H
#define FULFIL_DISPENSE_MATRIX3XD_CV_CONVERTER_H
/**
 ...
 *
 * article uses eigen2cv(a) = cv::imread("lena.jpg", cv::IMREAD_GRAYSCALE);
 */
...
#endif //FULFIL_DISPENSE_MATRIX3XD_CV_CONVERTER_H
