...
#ifndef FULFIL_DEPTHCAM_GCP_FTP_VIDEO_SENDER_H
#define FULFIL_DEPTHCAM_GCP_FTP_VIDEO_SENDER_H
...
namespace fulfil
{
    namespace depthcam
    {
        namespace data
        {
            class FTP_GCS_VideoSender : public FileSender
            {
            private:
                std::shared_ptr<FTPSender> ftp_sender;
            ...
            public:
                ...
                FTP_GCS_VideoSender(const std::string& local_root_dir, const std::string& ftp_root_dir,
                                    const std::string& gcs_bucket_name, const std::string& store_id);

                FTP_GCS_VideoSender(std::shared_ptr<FTPSender> ftp_sender, std::shared_ptr<GCSSender> gcs_sender);
