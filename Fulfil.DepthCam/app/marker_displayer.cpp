// Eric H TODO: should probably delete this file since it wasn't compiling
...
int main(int argc, char** argv)
{
  ...
  //std::shared_ptr<fulfil::depthcam::aruco::MarkerDetector> detector = std::make_shared<fulfil::depthcam::aruco::MarkerDetector>(2, 2);
  while(true)
  {
    session->refresh();
