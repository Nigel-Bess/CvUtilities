...
void UntranslatedPointCloud::apply_filter_side_dispense(std::shared_ptr<fulfil::utils::eigen::Matrix3XdFilter> filter)
{
    this->inner_point_cloud = filter->filter_side_dispense(inner_point_cloud);
}

void UntranslatedPointCloud::apply_filter_side_dispense_point_cloud_outside_cavity(std::shared_ptr<fulfil::utils::eigen::Matrix3XdFilter> filter)
{
